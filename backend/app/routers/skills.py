...
from app.models.skill import SkillCategory, Skill, StudentSkill, CareerRole
from app.schemas.skill import (
    SkillCategoryResponse, SkillCategoryCreate,
    SkillResponse, SkillCreate,
    StudentSkillResponse, StudentSkillCreate,
    CareerRoleResponse
)

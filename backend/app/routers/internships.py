...
from app.models.profile import StudentProfile, IndustryProfile
from app.models.internship import Internship, InternshipTask, MentorFeedback
from app.schemas.internship import (
    InternshipResponse, TaskCreate, TaskSubmit, TaskReview, TaskResponse,
...
def get_internships(
    ...
    if current_user.role == "student":
        ...
        student_ids = [s.id for s in db.query(StudentProfile.id).filter(StudentProfile.institution_id == current_user.institution_id).all()]

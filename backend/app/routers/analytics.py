...
from app.schemas.analytics import (
    AdminAnalyticsResponse, InstitutionAnalyticsResponse,
    IndustryAnalyticsResponse, StudentAnalyticsResponse
)
from app.core.deps import get_current_user, require_role
from app.services.analytics import (
    get_admin_analytics, get_institution_analytics,
    get_industry_analytics, get_student_analytics
)

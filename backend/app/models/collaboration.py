...
class Collaboration(Base):
    ...
    collaboration_type = Column(String(50), nullable=False, index=True)  # live_project, fdp, research, consultancy, workshop, guest_lecture, challenge, industrial_visit
    title = Column(String(255), nullable=False)
    description = Column(Text, nullable=False)
    status = Column(String(50), default="proposed", index=True)  # draft, proposed, accepted, in_progress, completed, declined

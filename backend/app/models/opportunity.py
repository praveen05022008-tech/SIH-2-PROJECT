...
class Opportunity(Base):
    ...
    type = Column(String(50), nullable=False, index=True)  # internship, job, apprenticeship, live_project, faculty_internship, industrial_training
...
class Application(Base):
    ...
    status = Column(String(50), default="applied", index=True)  # applied, under_review, shortlisted, selected, rejected, in_progress, completed
    ...
    __table_args__ = (
        UniqueConstraint('opportunity_id', 'applicant_user_id', name='uq_user_opportunity_application'),
    )
